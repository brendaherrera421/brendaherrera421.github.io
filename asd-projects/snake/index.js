...
function init() {
  // TODO 4c-2: initialize the snake !!COMPLETED!!
  ...
  // TODO 4b-2: initialize the apple !!COMPLETED!!
  makeApple();
  // TODO 5a: Initialize the interval
  // start update interval  !!COMPLETED!!
 ...
 */
function update() {
  // TODO 5b: Fill in the update function's code block !!COMPLETE!!
  moveSnake();
...
function checkForNewDirection(event) {
  /* 
  TODO 6b: Update snake.head.direction based on the value of activeKey. !!COMPLETED!!
...
function moveSnake() {
  ...
  */
  ...
  /* 
  TODO 7: determine the next row and column for the snake's head !!COMPLETED!!
 ...
 */
function makeApple() {
  // TODO 4b-1: Fill in the makeApple() code block !!COMPLETED!!
...
function makeSnakeSquare(row, column) {
  // TODO 4c-1: Fill in this function's code block !!COMPLETED!!
...
function handleKeyDown(event) {
  // TODO 6a: make the handleKeyDown function register which key is pressed. !!COMPLETED!!
